...
<p>The `master` branch has the latest source for DITA 1.3 Errata 2, published at: https://docs.oasis-open.org/dita/dita/v1.3/errata02/os/complete/part0-overview/dita-v1.3-errata02-os-part0-overview-complete.html</p>

<p>Development continues on DITA 2.0 using the `DITA-2.0` branch, focusing on the base DITA specification.</p>
